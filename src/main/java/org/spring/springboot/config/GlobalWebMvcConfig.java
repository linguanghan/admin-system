...
public class GlobalWebMvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/**")
                // 放行哪些原始域
                .allowedOrigins("https://wxwebpelbs.yfqp.shop", "http://wxwebpelbs.yfqp.shop",
                        "https://wxwebpelbstest.yfqp.shop", "http://wxwebpelbstest.yfqp.shop",
                        "http://mgrtest.yfqp.shop", "http://mgrylc.yfqp.shop",
                        "http://localhost:7456", "http://127.0.0.1:7456",
                        "http://localhost:81", "http://hmweb.yfqp.shop")
                // 是否发送Cookie信息
